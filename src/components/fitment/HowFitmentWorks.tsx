...
export function HowFitmentWorks() {
 return (
 <Card className="border-rule bg-paper-2 to-transparent">
 <CardContent className="p-6">
 <div className="flex items-start gap-4">
 <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256" className="flex-shrink-0">
 ...
 <div>
 <h3 className="font-semibold text-foreground mb-2 uppercase tracking-wider">How Role Fitment Interviews Work</h3>
 <p className="text-muted text-sm leading-relaxed">
 Role Fitment interviews are created automatically when you shortlist candidates from regular interviews.
