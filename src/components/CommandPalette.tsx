 ...
 * commands route to (unified_ia is now unconditional; see Task 4/5).
 */
...
export function CommandPalette() {
  ...
  const actions: PaletteAction[] = [
    ...
    // Create — both funnel into the single "Open a role" flow.
    {
      id: "create.interview.screening",
      label: "Create screening interview",
      shortcut: "C",
      group: "create",
      perform: () => navigate(COMMAND_TARGETS.createRoleUnified),
    },
    {
