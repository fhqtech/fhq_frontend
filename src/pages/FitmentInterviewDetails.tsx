...
export default function FitmentInterviewDetails() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          {loadingFitmentInterview ? (
            ...
            <>
              <h1 className="text-4xl font-bold text-foreground uppercase tracking-widest mb-2">{fitmentInterview?.title}</h1>
      ...
      <div className="bg-white rounded-sm border border-gray-200" style={{ boxShadow: 'inset 1px 1px 2px #e8e8e8, 2px 2px 4px #d5d5d5' }}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-foreground-muted mt-1 uppercase tracking-wider">Current settings and linked interviews</p>
              </div>
            </div>
              ...
              {!loadingFitmentInterview && fitmentInterview && (
                ...
                {fitmentInterview.status === 'draft' && (
                  <Button
                    ...
                    className="text-white font-medium rounded-sm uppercase"
                    style={{
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-6">
                ...
                {fitmentInterview?.parentInterviews && fitmentInterview.parentInterviews.length > 0 && (
                  <div>
                    <Label className="uppercase text-xs tracking-wider font-bold text-gray-900">Linked Primary Interviews</Label>
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {fitmentInterview.parentInterviews.map((interview, index) => (
                        <div
                          key={index}
                          className="p-4 bg-white border border-gray-300 rounded-sm hover:border-gray-400 transition-colors cursor-pointer"
                          style={{ boxShadow: 'inset 1px 1px 2px #e8e8e8, 2px 2px 4px #d5d5d5' }}
                          onClick={() => navigate(`/interview/${interview.interviewId}`)}
                        >
                          <div className="flex items-start justify-between mb-2">
                            <h4 className="font-semibold text-sm text-gray-900 uppercase tracking-wider">{interview.interviewTitle}</h4>
                          </div>
                          <p className="text-xs text-gray-500 font-mono break-all">ID: {interview.interviewId}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {/* Job Description */}
                <div>
                  <Label className="uppercase text-xs tracking-wider font-bold text-gray-900">Job Description</Label>
          ...
          <div className="px-6 py-5">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-foreground-muted mt-1 uppercase tracking-wider">View candidate lists attached to this fitment interview</p>
          ...
          <div className="p-6">
            {loadingCandidateLists ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-500">No candidate lists found</p>
              </div>
            ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col h-full">
                        <div className="mb-3">
                          <h4 className="font-medium text-sm transition-colors group-hover:text-white">{list.name}</h4>
                          <p className="text-[10px] text-gray-500 uppercase tracking-wider mt-1 transition-colors group-hover:text-white/60">
                            #{list.id}
                          </p>
                        </div>
                        {list.description && (
                          <p className="text-xs text-muted-foreground mb-3 line-clamp-2 transition-colors group-hover:text-white/80">{list.description}</p>
                        )}
                        <div className="mt-auto flex flex-col gap-2">
                          <div className="flex items-center gap-2">
                            <span className="text-xs text-muted-foreground transition-colors uppercase group-hover:text-white/70">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            {list.updatedAt && (
                              <span className="text-xs text-muted-foreground transition-colors group-hover:text-white/60">
      ...
      {fitmentInterview?.status === 'draft' ? (
        <div className="text-center py-12 space-y-4">
          <div>
            <h3 className="text-2xl font-semibold text-foreground uppercase tracking-wider">Fitment Assessment Not Started</h3>
          ...
          <Button
            onClick={handleStartFitmentInterview}
            className="text-white font-medium rounded-sm uppercase h-9 px-6 text-xs"
            style={{
              backgroundColor: '#222831',
              boxShadow: 'inset 1px 1px 2px #e8e8e8, 2px 2px 4px #d5d5d5'
            }}
        ...
        <div className="bg-white rounded-sm border border-gray-200 p-6" style={{ boxShadow: 'inset 1px 1px 2px #e8e8e8, 2px 2px 4px #d5d5d5' }}>
          <div className="mb-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-bold uppercase tracking-wider mb-1 text-gray-900">
                        ...
                        {candidate.invitationLink ? (
                          ...
                          >
                            {copiedCandidateId === candidate.id ? (
                              ...
                              <Copy className="h-4 w-4 text-foreground-muted hover:text-foreground" />
                            )}
                          </Button>
                        ) : (
